...
export function CustomButton({buttonText, icon, handleFunction, transparent, fullWidth}) {

    return (
        <Button onClick={handleFunction} transparent={transparent} fullWidth={fullWidth}>
            <ButtonContent>
                {icon && icon}
                {buttonText}
            </ButtonContent>
